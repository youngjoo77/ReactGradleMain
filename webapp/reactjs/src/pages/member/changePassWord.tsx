		...
		if (password && newPassword && confimPassword) {
			if (password.value === '') {
				let alertdata: CustomAlertInterface = {
					isOpen: true, severity: 'error', title: '비밀번호', content: '비밀번호의 값이 없습니다.', fnCallBack: function() {
				...
				let alertdata: CustomAlertInterface = {
					isOpen: true, severity: 'error', title: '신규 비밀번호', content: '신규 비밀번호의 값이 없습니다.', fnCallBack: function() {
						alertdata.isOpen = false;
						setAlertInfo(alertdata);
					}
				};
				...
				let alertdata: CustomAlertInterface = {
					isOpen: true, severity: 'error', title: '확인 비밀번호', content: '확인 비밀번호의 값이 없습니다.', fnCallBack: function() {
						alertdata.isOpen = false;
						setAlertInfo(alertdata);
					}
				};
			...
			if (password.value === newPassword.value) {
				let alertdata: CustomAlertInterface = {
					isOpen: true, severity: 'error', title: '비밀번호 확인', content: '기존 비밀번호와 신규 비밀번호의 값이 같습니다.', fnCallBack: function() {
						alertdata.isOpen = false;
						setAlertInfo(alertdata);
					}
				};
			...
			if (newPassword.value !== confimPassword.value) {
				let alertdata: CustomAlertInterface = {
					isOpen: true, severity: 'error', title: '비밀번호 확인', content: '신규 비밀번호와 확인 비밀번호 값이 다릅니다.', fnCallBack: function() {
						alertdata.isOpen = false;
						setAlertInfo(alertdata);
					}
				};
